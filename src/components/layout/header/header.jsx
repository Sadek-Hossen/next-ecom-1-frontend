...
const logout = async () => {
  ...
  <Link href="/login">
    <span className="relative z-10 transition-all duration-500 group-hover:px-8">
    <h1 className="p-3 px-6 rounded-2xl text-white text-center bg-gradient-to-r from-red-500 to-pink-500 transition duration-300 hover:scale-105 cursor-pointer">  Login</h1>
    </span>
  </Link>
)}
